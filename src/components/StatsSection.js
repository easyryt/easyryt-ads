...
import { Grid, Typography, Box, Container, useTheme, Button } from '@mui/material';
    ...
    <Box 
      sx={{
        ...
        '&:after': {
          ...
          height: '600px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(182, 140, 58, 0.1) 0%, rgba(255,255,255,0) 70%)',
          zIndex: 0,
        },
      }}
    >
      <Container maxWidth="lg">
        <Box sx={{ mb: { xs: 5, md: 8 }, textAlign: 'center', px: { xs: 2, sm: 0 } }}>
          <Typography 
            variant="overline" 
            sx={{
              fontSize: '0.8rem',
          ...
          >
            Our track record speaks for itself. With years of expertise and a dedicated team, 
            we consistently deliver outstanding outcomes for our clients.
          </Typography>
        </Box>
        ...
        {/* Call to action */}
        <Box sx={{ mt: { xs: 6, md: 8 }, textAlign: 'center', px: { xs: 2, sm: 0 } }}>
          <Typography 
            variant="body1" 
            sx={{
              color: '#cbd5e8',
          ...
          >
            Ready to achieve exceptional results for your business? 
