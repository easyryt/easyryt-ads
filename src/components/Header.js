...
import { AppBar, Toolbar, Typography, Box, IconButton, Container, Menu, MenuItem, Button, Fade, Divider } from '@mui/material';
import { WhatsApp, MailOutline, Phone, Menu as MenuIcon } from '@mui/icons-material';
import { styled, alpha } from '@mui/material/styles';

const PremiumAppBar = styled(AppBar)(({ theme }) => ({
  background: 'linear-gradient(to bottom, rgba(10, 15, 30, 0.95) 0%, rgba(5, 10, 20, 0.85) 100%)',
...
const WhatsAppButton = styled(IconButton)({
  background: 'linear-gradient(45deg, rgba(37, 211, 102, 0.15) 0%, rgba(37, 211, 102, 0.25) 100%)',
  color: '#25D366',
  padding: '10px',
  borderRadius: '50%',
  ...
  '&:hover': {
    background: 'linear-gradient(45deg, rgba(37, 211, 102, 0.25) 0%, rgba(37, 211, 102, 0.35) 100%)',
        ...
        <Toolbar disableGutters sx={{ 
          ...
          <ContactInfo>
            <ContactItem onClick={handleEmail}>
              <IconWrapper>
                <MailOutline fontSize="small" sx={{ color: '#8a2be2', fontSize: '1.1rem' }} />
              </IconWrapper>
            ...
            <ContactItem onClick={handleCall}>
              <IconWrapper>
                <Phone fontSize="small" sx={{ color: '#1e90ff', fontSize: '1.1rem' }} />
              </IconWrapper>
